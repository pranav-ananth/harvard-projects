...
// example: uses inheritance to make GUI an ActionListener
public class GUI implements ActionListener   // GUI HAS-A JFrame; GUI IS-A ActionListener
{
    ...
    public GUI(){
        frame = new JFrame("my Tremilliamilliamilliatrecentretriginmilliamilliatrecentretriginmilliatrecendotrigintillion GUI");
