package com.wordle;/*
 * File: com.wordle.WordleEventListener.java
 * ------------------------------
 * This file defines an interface that is used to specify event
 * callbacks in the com.wordle.Wordle project.
 */
 ...
 * com.wordle.Wordle assignments.  The easiest way to use this interface  is to use
...
/*
 * This function defines com.wordle.WordleEventListener as a functional interface,
