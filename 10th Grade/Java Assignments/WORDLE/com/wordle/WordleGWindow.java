package com.wordle;/*
 * File: com.wordle.WordleGWindow.java
 * ------------------------
 * This file implements the com.wordle.WordleGWindow class, which manages the
 * graphical display for the com.wordle.Wordle project.
 */
...
/**
 * This class implements graphics for the com.wordle.Wordle assignment.
 */

public class WordleGWindow {

/** The number of rows in the com.wordle.Wordle grid. */
    public static final int N_ROWS = 6;

/** The number of columns in the com.wordle.Wordle grid. */
...
/**
 * Creates a new com.wordle.WordleGWindow object and displays it on the screen.
 */

    public WordleGWindow() {
        JFrame frame = new JFrame("com.wordle.Wordle");
 ...
 *
 * @param listener The com.wordle.WordleEventListener waiting for this event
 */
...
/**
 * Repaints the com.wordle.Wordle canvas.  This method is called automatically when
...
/*
 * Initializes the com.wordle.Wordle grid, which is a two-dimensional array of
...
/*
 * Initializes the com.wordle.Wordle keys object, which is a map from key labels to
 * WordleKey objects.
 */
